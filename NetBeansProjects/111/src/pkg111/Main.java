...
class AprioriCalculation
{
    ...
    private void getConfig()
    {
        ...
        //configFile=Main.path+configFile;
        transaFile=Main.path+transaFile;
        //outputFile=Main.path+outputFile;
        String input="";
    ...
    {System.out.println(" generating candidates ie joining step");
        ...
        //if its the first set, candidates are just the numbers  // candidate 1item set seed set
        if(n==1)
        {
    ...
    private void calculateFrequentItemsets(int n)
    {
        ...
        try
        {            System.out.println("in try block for calculating frequent itemsets");
                //output file
